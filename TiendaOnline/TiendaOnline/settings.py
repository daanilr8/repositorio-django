...
SECRET_KEY = 'django-insecure-bdxra*yaf=v09=dc)h5gt8_hj6#$rg1gk^bq$snqxg9$c9mc-3'
...
STATIC_URL = 'static/'
staticfilesdir = os.path.join(BASE_DIR,'cuestionariosIA')
STATICFILES_DIRS = [
    os.path.join(staticfilesdir, 'static'),
]
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR
...
EMAIL_USE_TLS = True
EMAIL_PORT=587
EMAIL_HOST_USER = "supraaazk@gmail.com"
EMAIL_HOST_PASSWORD= "brr"